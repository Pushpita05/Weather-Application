        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <div class="card-body">
             ...
             <div class="col-md-6 form-group">
                 <label>Name</label>
                 <input type="text" name="name" class="form-control"  maxlength="20" placeholder="name" required>
             </div>  
              <div class="col-md-6 form-group">
                 <label>Surname</label>
                 <input type="text" name="surname" class="form-control"  maxlength="20" placeholder="surname" required>
             </div>       
         ...
         <div class="row">
             <div class="col-md-6 form-group">
                 ...
                 <div class="col-md-6 form-group">
                 <label>Region</label>
                 <input type="text" name="region" class="form-control" maxlength="20"  required>
             </div> 
            ...
            <?php echo date('Y');?> &copy;  Made by Pushpita Boral 
            </p>
            </footer>
           <div class="line"></div> 
