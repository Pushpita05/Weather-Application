...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  font-size: 16px;
">Search for Weather</button></a>
             </div>
    <button class="btn btn-dark d-inline-block d-lg-none ml-auto" type="button" data-toggle="collapse" data-target="main.php" href="main.php" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
