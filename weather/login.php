...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('img/banner.png'); ">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<div class="">
					<p style="color:white">Don't have an account? <a style="color:white" href="signup.html">Signup</a></p>
				</div>
			</div>
		</div>
	</div>
